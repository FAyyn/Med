...
# 直接导入需要的模块，避免导入整个utils包
try:
    from utils import LlavaMistralConfig, LlavaMistralForCausalLM, load_pretrained_model, IMAGE_TOKEN_INDEX, DEFAULT_IMAGE_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN, download
except ImportError:
    # 如果导入失败，尝试从当前目录导入
    from .utils import LlavaMistralConfig, LlavaMistralForCausalLM, load_pretrained_model, IMAGE_TOKEN_INDEX, DEFAULT_IMAGE_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN, download
